...
/// Runtime fallback for the data-sphere Metal program.
///
/// The precompiled `.metal` file remains the preferred production path. This
/// source is intentionally identical so the component still renders when an
/// XcodeGen/source-build configuration does not place that file in default.metallib.
enum IumrahDataSphereShaderSource {
    static let source = #"""
